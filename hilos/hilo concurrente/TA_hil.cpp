...
int main(int argc, char* argv[]){
	...
	fflush(stdout);
	t1 = clock();
	// comienza el procesamientoe

	while(i < max_threads){
		
            //int fac = factorial(j);
            //void* facto = &fac;
            //void* facto = &factorial(j);
           err = pthread_create(&tid[i], NULL, &facto, (void*)i);
		/*if (err != 0)
  ...
  // int n,i,j;
   ...
   pthread_create(&fact_thread, NULL, facto, &factorial );*/
}
